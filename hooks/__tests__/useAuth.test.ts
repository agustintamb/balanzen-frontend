...
describe('useRegister', () => {
  describe('when registration succeeds', () => {
    it('should return data on successful consumer registration', async () => {
      ...
      expect(mockedAuthService.register).toHaveBeenCalledWith(CONSUMER_REGISTER_BODY, expect.anything())
    })
    ...
    it('should call authService.register with commerce body', async () => {
      ...
      expect(mockedAuthService.register).toHaveBeenCalledWith(COMMERCE_REGISTER_BODY, expect.anything())
  ...
  describe('when registration fails', () => {
    ...
    it('should invoke onError callback when mutation fails', async () => {
      ...
      expect(onError).toHaveBeenCalledWith(error, CONSUMER_REGISTER_BODY, undefined, expect.anything())
    })
  })
...
describe('useLogin', () => {
  describe('when login succeeds', () => {
    it('should return LoginResponse on success', async () => {
      ...
      expect(mockedAuthService.login).toHaveBeenCalledWith(LOGIN_BODY, expect.anything())
    })
    ...
    it('should invoke onSuccess callback with LoginResponse', async () => {
      ...
      expect(onSuccess).toHaveBeenCalledWith(LOGIN_RESPONSE, LOGIN_BODY, undefined, expect.anything())
    })
  })
...
describe('useRefreshToken', () => {
  describe('when refresh succeeds', () => {
    ...
    it('should invoke onSuccess callback with new token', async () => {
      ...
      expect(onSuccess).toHaveBeenCalledWith(refreshResponse, undefined, undefined, expect.anything())
    })
  })
...
describe('useChangePassword', () => {
  describe('when change password succeeds', () => {
    it('should call authService.changePassword with correct body', async () => {
      ...
      expect(mockedAuthService.changePassword).toHaveBeenCalledWith(CHANGE_PASSWORD_BODY, expect.anything())
  ...
  describe('when change password fails', () => {
    ...
    it('should invoke onError callback on failure', async () => {
      ...
      expect(onError).toHaveBeenCalledWith(error, CHANGE_PASSWORD_BODY, undefined, expect.anything())
    })
  })
