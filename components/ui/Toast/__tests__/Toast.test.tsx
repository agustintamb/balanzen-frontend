...
describe("Toast", () => {
  ...
  describe("Visibility", () => {
    it("should render nothing when toast.visible is false", () => {
      mockUseUIStore.mockReturnValue(
        buildStoreState({ visible: false, message: "Hello" }) as ReturnType<
          typeof useUIStore
        >,
      );
  ...
  describe("Message display", () => {
    ...
    it("should display a long message truncated to 3 lines via numberOfLines prop", () => {
      const longMessage =
        "This is a very long message that should be truncated after three lines of text in the toast component";
      mockUseUIStore.mockReturnValue(
        buildStoreState({
          visible: true,
          message: longMessage,
  ...
  describe("Type-based styling", () => {
    ...
    it("should apply success background color when type is success", () => {
      ...
      const containerStyle = message.parent?.parent?.props.style as Record<
        string,
        unknown
      >;
  ...
  describe("Auto-dismiss", () => {
    ...
    it("should call hideToast after AUTO_DISMISS_MS (3500ms)", () => {
      ...
      mockUseUIStore.mockReturnValue(
        buildStoreState(
          { visible: true, message: "Auto hide me", type: "success" },
          hideToast,
        ) as ReturnType<typeof useUIStore>,
      );
    ...
    it("should not call hideToast before the 3500ms timeout elapses", () => {
      ...
      mockUseUIStore.mockReturnValue(
        buildStoreState(
          { visible: true, message: "Still here", type: "info" },
          hideToast,
        ) as ReturnType<typeof useUIStore>,
      );
  ...
  describe("Manual dismiss", () => {
    it("should call hideToast when the close button is pressed", () => {
      ...
      mockUseUIStore.mockReturnValue(
        buildStoreState(
          { visible: true, message: "Dismiss me", type: "error" },
          hideToast,
        ) as ReturnType<typeof useUIStore>,
      );
      ...
      // The close icon rendered by the mock has testID "icon-x" (Feather name="x")
      const closeIcon = getByTestId("icon-x");
      fireEvent.press(
        closeIcon.parent as unknown as ReturnType<typeof getByTestId>,
      );
    ...
    it("should call hideToast when the toast body is pressed", () => {
      ...
      mockUseUIStore.mockReturnValue(
        buildStoreState(
          { visible: true, message: "Tap to dismiss", type: "success" },
          hideToast,
        ) as ReturnType<typeof useUIStore>,
      );
  ...
  describe("Edge cases", () => {
    it("should still render while the exit animation is running after toast.visible becomes false", () => {
      ...
      mockUseUIStore.mockReturnValue(
        buildStoreState(
          { visible: true, message: "Visible", type: "info" },
          hideToast,
        ) as ReturnType<typeof useUIStore>,
      );
      ...
      mockUseUIStore.mockReturnValue(
        buildStoreState(
          { visible: false, message: "Visible", type: "info" },
          hideToast,
        ) as ReturnType<typeof useUIStore>,
      );
