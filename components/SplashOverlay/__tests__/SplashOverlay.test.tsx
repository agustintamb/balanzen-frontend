...
describe('SplashOverlay', () => {
  describe('initial render — splash visible', () => {
    ...
    it('should render LottieView when splash is visible', () => {
      ...
      const lottie = UNSAFE_getByType('LottieView' as unknown as React.ComponentType)
    ...
    it('should render LinearGradient with the correct gradient colors', () => {
      ...
      const gradient = UNSAFE_getByType('LinearGradient' as unknown as React.ComponentType)
      expect(gradient.props.colors).toEqual(['#1A3408', '#22470C', '#2D6012', '#3A7A1C'])
    })
  ...
  describe('after animation completes — splash hidden', () => {
    ...
    it('should not render LottieView after the animation completes', () => {
      ...
      const lottie = UNSAFE_queryByType('LottieView' as unknown as React.ComponentType)
    ...
    it('should not render LinearGradient after the animation completes', () => {
      ...
      const gradient = UNSAFE_queryByType('LinearGradient' as unknown as React.ComponentType)
