...
describe("TabBar", () => {
  ...
  describe("tab rendering", () => {
    ...
    it("should render RegularTab for home and profile routes", () => {
      ...
      expect(getByTestId("tab-home").props.accessibilityLabel).toBe(
        "regular-Inicio",
      );
      expect(getByTestId("tab-profile").props.accessibilityLabel).toBe(
        "regular-Perfil",
      );
    });
    ...
    it("should render FeaturedTab for the orders route", () => {
      ...
      expect(getByTestId("tab-orders").props.accessibilityLabel).toBe(
        "featured-Mis pedidos",
      );
    });
    ...
    it("should skip routes that have no config entry", () => {
      ...
      const { getByTestId, queryByTestId } = render(
        <TabBar {...buildTabBarProps(routes)} />,
      );
  ...
  describe("active state", () => {
    it("should mark the active tab as selected via accessibilityState", () => {
      ...
      const { getByTestId } = render(
        <TabBar {...buildTabBarProps(CONSUMER_ROUTES, 0)} />,
      );
      // Assert
      expect(getByTestId("tab-home").props.accessibilityState?.selected).toBe(
        true,
      );
      expect(getByTestId("tab-orders").props.accessibilityState?.selected).toBe(
        false,
      );
      expect(
    ...
    it("should mark the orders tab as selected when index is 1", () => {
      // Arrange
      const { getByTestId } = render(
        <TabBar {...buildTabBarProps(CONSUMER_ROUTES, 1)} />,
      );
      // Assert
      expect(getByTestId("tab-home").props.accessibilityState?.selected).toBe(
        false,
