...
const mockUseRegisterRoleSection =
  useRegisterRoleSection as jest.MockedFunction<typeof useRegisterRoleSection>;
...
describe("RegisterRoleSection", () => {
  describe("rendering", () => {
    ...
    it("should render both role descriptions", () => {
      ...
      // Assert
      expect(
        getByText("Explorá alimentos frescos a precios increíbles."),
      ).toBeTruthy();
      expect(
        getByText("Publicá excedentes y reducí las pérdidas del negocio."),
      ).toBeTruthy();
    });
