...
describe("addressesService", () => {
  describe("search", () => {
    ...
    it("should propagate network errors from search", async () => {
      ...
      await expect(addressesService.search("Corrientes")).rejects.toThrow(
        "Network Error",
      );
    });
  ...
  describe("create", () => {
    ...
    it("should propagate validation errors from create", async () => {
      ...
      await expect(
        addressesService.create(buildAddressInput()),
  ...
  describe("update", () => {
    ...
    it("should propagate errors from update", async () => {
      ...
      await expect(addressesService.update("missing-id", {})).rejects.toThrow(
        "Address not found",
      );
    });
  });
  ...
  describe("delete", () => {
    ...
    it("should propagate errors from delete", async () => {
      ...
      await expect(
        addressesService.delete("protected-addr-id"),
  ...
  describe("select", () => {
    ...
    it("should propagate errors from select", async () => {
      ...
      await expect(addressesService.select("addr-id")).rejects.toThrow(
